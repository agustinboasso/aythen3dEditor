...
export default class ObjectGenerator {
    ...
    createText(text = 'Atyhen', textGeometryOptions, material = this.getMaterial(), attachProperties = true) {
    ...
    addText(text = 'Aythen', onAfterAdd = (t) => { }, material = this.getMaterial(), textGeometryOptions = {
        size: 0.5,
        height: 0.2,
        curveSegments: 6,
        bevelEnabled: true,
